...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "ME":
        return "uid=4217102784&password=2D99628D3083D88F0997093B5D3E65F5ED13321941FB7B3FCDFB207E203832BE"
    elif r == "BD":
        return "uid=4217102784&password=BY_ROHANo-TQIEWEJPY-REDZED"
